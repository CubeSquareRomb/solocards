...
import com.rombsquare.solocards.presentation.screens.writing_mode.components.AnswerInput
...
@Composable
fun WritingGameScreen(onEvent: (UiEvent?) -> Unit, uiState: State<UiState>, navigate: (String) -> Unit) {
        ...
        content = { innerPadding ->
            Column(Modifier
                ...
                AnswerInput(
                    Modifier,
                    onSend = {
                        onEvent(UiEvent.ConfirmAnswer(it))
                    }
                )
            }
        }
